<template>
    ...
    <div class="fixed-action-btn" id="floatBtn">
        <a id="float-menu" class="btn-floating btn-large grey darken-3">
...
export default {
    ...
    computed: {
        ...
        userRole: function() {
            return this.authenticated ? this.$store.getters.getUserRole : 1 
        }
